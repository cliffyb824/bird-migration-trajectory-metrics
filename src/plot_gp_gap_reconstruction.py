"""Plot GP gap-reconstruction uncertainty diagnostics."""
...
METHOD_LABELS = {
    ...
    "gp_sample": "GP posterior samples",
}

PANELS = [
    ("matrix_spearman", "Distance-matrix rank correlation", (0.0, 1.05)),
    ("median_relative_error", "Median relative distance error", (0.0, 0.7)),
...
def read_summary(path):
    """Read summarized GP diagnostics."""
    rows = []
...
def main():
    ...
    parser.add_argument(
        "--output",
        default="figures/gp_gap_reconstruction_summary.png",
    )
    ...
    x_positions = {
        ...
        ("raw_dtw", "gp_sample"): 1.2,
        ("srvf_dtw", "spherical_bridge"): 1.8,
        ("srvf_dtw", "gp_sample"): 2.2,
    }
    colors = {"spherical_bridge": "#E69F00", "gp_sample": "#009E73"}
    markers = {"spherical_bridge": "o", "gp_sample": "s"}
    ...
    fig.suptitle("GP Posterior Route Samples Expose Gap-Reconstruction Uncertainty")
