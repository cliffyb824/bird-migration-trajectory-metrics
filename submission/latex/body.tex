...
\caption{Route-gap uncertainty workflow for animal tracking data. Panels (a) and (b) show how a contiguous GPS gap is represented as either a single deterministic bridge or an ensemble of plausible Brownian bridge reconstructions. Panel (c) illustrates empirical envelope calibration against withheld observations. Panel (d) summarizes how reconstructed route uncertainty is propagated into distance matrices, clustering, anomaly ranks, and uncertainty summaries.}
