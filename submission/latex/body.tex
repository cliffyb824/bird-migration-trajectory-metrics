...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{../../figures/route_gap_uncertainty_framework_v2.png}
\caption{Route-gap uncertainty workflow for animal tracking data. Panel (a) shows transit-focused migratory routes used in the case study. Panels (b) and (c) illustrate how a prolonged GPS gap hides route geometry and how deterministic and stochastic reconstructions represent different assumptions about the missing segment. Panels (d)--(f) summarize validation, calibration, and propagation into route-comparison outputs, including distance-matrix stability, cluster agreement, and anomaly-related diagnostics.}
