...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{../../figures/route_gap_uncertainty_framework_v3.png}
\caption{Route-gap uncertainty workflow for animal tracking data. Panel (a) shows transit-focused migratory routes in the case study. Panels (b) and (c) show a withheld contiguous gap in one route and the corresponding deterministic bridge and Brownian bridge route ensemble. Panels (d)--(f) summarize envelope calibration and downstream effects on route-comparison stability.}
